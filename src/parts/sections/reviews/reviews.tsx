...
const temp = [
  ...
  },
  {
    ...
    name: 'Sofia Map',
    position: 'SEO',
    text: 'Blown away by Plumpix’s work! They delivered a sleek, interactive, and user-friendly solution that makes everything a breeze. Their team brought fresh ideas, nailed the technical side, and kept everything smooth from start to finish. Great communication, on-time delivery, and a result that stands out.',
